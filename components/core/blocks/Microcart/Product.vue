  ...
  <div style="display: contents">
    <tr v-if="component == 'cart'">
      ...
      <td>
        <ul>
          <li>
            <div class="base-price price-box" v-if="product.special_price && parseFloat(product.original_price_incl_tax) > 0 && !onlyImage">
            ...
            <div class="base-price price-box" v-if="!product.special_price && parseFloat(product.price_incl_tax) > 0 && !onlyImage">
