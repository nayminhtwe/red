      ...
      <div class="row">
        ...
        <div class="col-xs-12 col-md-3 serif">
          ...
          <div v-if="product.special_price">
            <span class="h4 cl-error">{{ product.price_incl_tax * product.qty | price(storeView) }} </span>
            <span class="price-original h5">{{ product.original_price_incl_tax * product.qty | price(storeView) }}</span>
            
          </div>
          <div v-else>
            <span class="h4">{{ product.price_incl_tax * product.qty | price(storeView) }}</span>
          </div>
        </div>
      </div>
    </div>
