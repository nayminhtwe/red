          ...
          <div class="popup-detail">
            <div class="row">
              ...
              <div class="col-lg-4">
                <a href="login.html">
                  <div class="account-inner">
                    <i class="fa fa-share-square-o" /><br>
                    <span>log out</span>
                  </div>
                </a>
              </div>
